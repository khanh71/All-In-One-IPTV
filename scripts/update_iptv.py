...
DISPLAY_NAME: dict[str, str] = {
    ...
    "quangninh1": "Quảng Ninh TV1",   "quangninh3": "Quảng Ninh TV3",
    "bacgiang":   "Bắc Giang TV",
    "bacninh":    "Bắc Ninh TV",
    "hanoi1":     "Hà Nội TV1",       "hanoi2":    "Hà Nội TV2",
    "vovgthn":    "VOV Giao Thông HN",
    "haiphong":   "Hải Phòng TV",     "haiphong3": "Hải Phòng TV3",
    ...
    "vinhlong1hd":"THVL1",  "thvl1hd": "THVL1",  "thvl1": "THVL1",
    "vinhlong2hd":"THVL2",  "thvl2hd": "THVL2",  "thvl2": "THVL2",
    "vinhlong3hd":"THVL3",  "thvl3hd": "THVL3",  "thvl3": "THVL3",
    "vinhlong4hd":"THVL4",  "thvl4hd": "THVL4",  "thvl4": "THVL4",
    "vinhlong5hd":"THVL5",  "thvl5hd": "THVL5",  "thvl5": "THVL5",
    "travinh":    "Trà Vinh TV",
    "angiang1":   "An Giang TV1",   "angiang2":  "An Giang TV2",
    "angiang3":   "An Giang TV3",
    "kiengiang":  "Kiên Giang TV",
    "cantho":     "Cần Thơ TV",     "cantho1":   "Cần Thơ TV1",
    "cantho2":    "Cần Thơ TV2",    "cantho3":   "Cần Thơ TV3",
    "haugiang":   "Hậu Giang TV",
    "soctrang":   "Sóc Trăng TV",
    "baclieu":    "Bạc Liêu TV",
    "camau":      "Cà Mau TV",
    # Quốc phòng
    "antv-hd":  "ANTV",   "antv": "ANTV",
    "qpvn-hd":  "QPVN",   "qpvn": "QPVN",
}
...
GROUP_MAP: dict[str, str] = {
    "VTV": "VTV",
    "HTV": "HTV",  "HTV/HTVC": "HTV",
    # Địa phương tỉnh thành (1.org.vn)
    "Hà Giang":"Hà Giang","Tuyên Quang":"Tuyên Quang","Cao Bằng":"Cao Bằng",
    "Lạng Sơn":"Lạng Sơn","Bắc Kạn":"Bắc Kạn","Thái Nguyên":"Thái Nguyên",
    "Quảng Ninh":"Quảng Ninh","Bắc Giang":"Bắc Giang","Bắc Ninh":"Bắc Ninh",
    "Lào Cai":"Lào Cai","Yên Bái":"Yên Bái","Phú Thọ":"Phú Thọ",
    "Vĩnh Phúc":"Vĩnh Phúc","Hà Nội":"Hà Nội","Hòa Bình":"Hòa Bình",
    "Sơn La":"Sơn La","Điện Biên":"Điện Biên","Lai Châu":"Lai Châu",
    "Hải Phòng":"Hải Phòng","Hải Dương":"Hải Dương","Hưng Yên":"Hưng Yên",
    "Thái Bình":"Thái Bình","Nam Định":"Nam Định","Hà Nam":"Hà Nam",
    "Ninh Bình":"Ninh Bình","Thanh Hóa":"Thanh Hóa","Nghệ An":"Nghệ An",
    "Hà Tĩnh":"Hà Tĩnh","Quảng Bình":"Quảng Bình","Quảng Trị":"Quảng Trị",
    "Thừa Thiên Huế":"Thừa Thiên Huế","Đà Nẵng":"Đà Nẵng",
    "Quảng Nam":"Quảng Nam","Quảng Ngãi":"Quảng Ngãi","Bình Định":"Bình Định",
    "Phú Yên":"Phú Yên","Khánh Hòa":"Khánh Hòa","Ninh Thuận":"Ninh Thuận",
    "Bình Thuận":"Bình Thuận","Kon Tum":"Kon Tum","Gia Lai":"Gia Lai",
    "Đắk Lắk":"Đắk Lắk","Đắk Nông":"Đắk Nông","Lâm Đồng":"Lâm Đồng",
    "Bình Phước":"Bình Phước","Tây Ninh":"Tây Ninh","Bình Dương":"Bình Dương",
    "Đồng Nai":"Đồng Nai","Bà Rịa - Vũng Tàu":"Bà Rịa - Vũng Tàu",
    "Long An":"Long An","Tiền Giang":"Tiền Giang","Bến Tre":"Bến Tre",
    "Đồng Tháp":"Đồng Tháp","Vĩnh Long":"Vĩnh Long","Trà Vinh":"Trà Vinh",
    "An Giang":"An Giang","Kiên Giang":"Kiên Giang","Cần Thơ":"Cần Thơ",
    "Hậu Giang":"Hậu Giang","Sóc Trăng":"Sóc Trăng","Bạc Liêu":"Bạc Liêu",
    "Cà Mau":"Cà Mau",
    # Quốc phòng
...
TVGID_TO_PROVINCE: dict[str, Optional[str]] = {
    "hagiang":"Hà Giang","tuyenquang":"Tuyên Quang","caobang":"Cao Bằng",
    "langson":"Lạng Sơn","backan":"Bắc Kạn","thainguyen":"Thái Nguyên",
    "quangninh":"Quảng Ninh","quangninh1":"Quảng Ninh","quangninh3":"Quảng Ninh",
    "bacgiang":"Bắc Giang","bacninh":"Bắc Ninh",
    "laocai":"Lào Cai","yenbai":"Yên Bái","phutho":"Phú Thọ","vinhphuc":"Vĩnh Phúc",
    "hanoi1":"Hà Nội","hanoi2":"Hà Nội","vovgthn":"Hà Nội",
    "hoabinh":"Hòa Bình","sonla":"Sơn La","dienbien":"Điện Biên",
    "laichau":"Lai Châu","ltv":"Lai Châu",
    "haiphong":"Hải Phòng","haiphong3":"Hải Phòng","haiphongplus":"Hải Phòng",
    "haiduong":"Hải Dương","hungyen":"Hưng Yên","thaibinh":"Thái Bình",
    "namdinh":"Nam Định","hanam":"Hà Nam","ninhbinh":"Ninh Bình",
    "thanhhoa":"Thanh Hóa","nghean":"Nghệ An","hatinh":"Hà Tĩnh",
    "quangbinh":"Quảng Bình","quangtri":"Quảng Trị","hue":"Thừa Thiên Huế",
    "danang1":"Đà Nẵng","danang2":"Đà Nẵng",
    "quangnam":"Quảng Nam","quangngai":"Quảng Ngãi","quangngai1":"Quảng Ngãi",
    "quangngai2":"Quảng Ngãi","binhdinh":"Bình Định","phuyen":"Phú Yên",
    "khanhhoa":"Khánh Hòa","khanhhoa1":"Khánh Hòa",
    "ninhthuan":"Ninh Thuận","binhthuan":"Bình Thuận",
    "kontum":"Kon Tum","gialai":"Gia Lai","daklak":"Đắk Lắk","daknong":"Đắk Nông",
    "lamdong":"Lâm Đồng","lamdong1":"Lâm Đồng","lamdong2":"Lâm Đồng","lamdong3":"Lâm Đồng",
    "binhphuoc":"Bình Phước","tayninh1":"Tây Ninh","tayninhtv":"Tây Ninh",
    "binhduong":"Bình Dương",
    "dongnai1":"Đồng Nai","dongnai2":"Đồng Nai","dongnai3":"Đồng Nai",
    "baria":"Bà Rịa - Vũng Tàu","longan":"Long An","tiengiang":"Tiền Giang",
    "bentre":"Bến Tre","dongthap":"Đồng Tháp","dongthap1":"Đồng Tháp","dongthap2":"Đồng Tháp",
    "vinhlong1hd":"Vĩnh Long","vinhlong2hd":"Vĩnh Long","vinhlong3hd":"Vĩnh Long",
    "vinhlong4hd":"Vĩnh Long","vinhlong5hd":"Vĩnh Long",
    ...
    "haugiang":"Hậu Giang","soctrang":"Sóc Trăng","baclieu":"Bạc Liêu","camau":"Cà Mau",
    "antv-hd":"Quốc Phòng","antv":"Quốc Phòng","qpvn-hd":"Quốc Phòng","qpvn":"Quốc Phòng",
    # bỏ
    "hitv": None, "youtv": None, "htvkey": None,
}
...
HTV_FIXED_ORDER = [
    ...
    "HTVC Gia Đình","HTVC Phim","HTVC Phụ Nữ","HTVC Thuần Việt","HTVC+",
]
...
def resolve_epg_url() -> str:
    ...
    for url in EPG_URLS:
        try:
            ...
            pass
    print("  ⚠  Không tải được EPG, playlist sẽ không có lịch phát sóng.", file=sys.stderr)
    return ""
...
def parse_m3u(text: str) -> list[Channel]:
    ...
    while i < len(lines):
        ...
        if line.startswith("#EXTINF"):
            ...
            tvg_id  = (re.search(r'tvg-id="([^"]*)"',    line) or type('', (), {'group': lambda s,x: ''})()).group(1).strip()
            tvg_logo= (re.search(r'tvg-logo="([^"]*)"',  line) or type('', (), {'group': lambda s,x: ''})()).group(1).strip()
            src_grp = (re.search(r'group-title="([^"]*)"',line) or type('', (), {'group': lambda s,x: ''})()).group(1).strip()
...
def _is_live(url: str) -> bool:
    if not url.startswith(("http://", "https://")):
        return True
    try:
        r = requests.head(url, timeout=LINK_CHECK_TIMEOUT,
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=LINK_CHECK_WORKERS) as ex:
        ...
        for fut in concurrent.futures.as_completed(fmap):
            ...
            if done % 20 == 0 or done == len(unique):
                print(f"     {done}/{len(unique)}, sống: {sum(results.values())}", end="\r")
    print()
    return results
...
def pick_best(channels: list[Channel]) -> list[Channel]:
    ...
    print(f"     ✅ {live}/{len(live_map)} sống" + (f", bỏ {dead} chết" if dead else ""))
...
def main():
    ...
    print(f"📋  VTV: {gcnt['VTV']} | HTV: {gcnt['HTV']} | Địa phương: {gcnt[GROUP_LABEL_LOCAL]} | Tổng: {len(final)}")
